...
exports.verifyAuth = exports.verifyCustomer = exports.verifyAdmin = void 0;
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const isUserExist = yield prisma.user.findUnique({
                where: {
                    id: (_a = req === null || req === void 0 ? void 0 : req.user) === null || _a === void 0 ? void 0 : _a.userId,
                },
            });
            if (!isUserExist || !allowedRoles.includes((_b = req.user) === null || _b === void 0 ? void 0 : _b.role)) {
                return res.status(401).json({ message: 'Unauthorized' });
            }
            next();
        }
