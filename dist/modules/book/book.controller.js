...
const getBooks = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filter = (0, pick_1.default)(req.query, constants_1.bookFilters);
    const result = yield book_service_1.bookService.getBooks(paginationOptions, filter);
    (0, sendRespnse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: 'Book created successfully',
...
const getBooksCategoryId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
